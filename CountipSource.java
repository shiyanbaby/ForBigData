...
public class CountipSource {
    ...
    public static void main(String[] args) {
        JobUtil.commitJob(CountipSource.class,"D:\\Program Files\\feiq\\Recv Files\\MapReducer所有内容\\MapReduce经典案例 WordCount 练习题及答案\\MapReduce经典案例 WordCount 练习题及答案\\实验数据","");
    }
}

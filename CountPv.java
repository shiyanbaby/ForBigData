...
public class CountPv {
    public static class ForMapper extends Mapper<LongWritable,Text,Text,NullWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            String arrray[]=value.toString().split(" ");
            okey.set(arrray[6]);
    ...
    public static void main(String[] args) {
        JobUtil.commitJob(CountPv.class,"D:\\Program Files\\feiq\\Recv Files\\MapReducer所有内容\\MapReduce经典案例 WordCount 练习题及答案\\MapReduce经典案例 WordCount 练习题及答案\\实验数据","");
    }
}
